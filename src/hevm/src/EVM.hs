  ...
  if self > 0x0 && self <= 0x9 then do
    ...
    then doStop
      ...
      case ?op of
          ...
          case stk of
            (xOffset':xSize':xs) ->
              ...
              then underrun
                ...
                forceConcrete xOffset' $ \xOffset -> do
        ...
        0x37 ->
          case stk of
            (xTo' : xFrom' : xSize' : xs) -> forceConcrete3 (xTo',xFrom',xSize') $ \(xTo,xFrom,xSize) -> do
        ...
        0x53 ->
          case stk of
            (x':(S _ y):xs) -> forceConcrete x' $ \x -> do
        ...
        0x56 ->
          case stk of
            (x:xs) -> do
              burn g_mid $ forceConcrete x $ \x' -> do
                checkJump x' xs
            _ -> underrun
